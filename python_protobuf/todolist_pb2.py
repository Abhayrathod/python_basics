...
_TODOLIST_LISTITEMS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='state', full_name='TodoList.ListItems.state', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='task', full_name='TodoList.ListItems.task', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='due_date', full_name='TodoList.ListItems.due_date', index=2,
...
_TODOLIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='owner_id', full_name='TodoList.owner_id', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='owner_name', full_name='TodoList.owner_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='todos', full_name='TodoList.todos', index=2,
...
TodoList = _reflection.GeneratedProtocolMessageType('TodoList', (_message.Message,), {
  ...
  'ListItems' : _reflection.GeneratedProtocolMessageType('ListItems', (_message.Message,), {
    ...
    # @@protoc_insertion_point(class_scope:TodoList.ListItems)
    })
  ,
