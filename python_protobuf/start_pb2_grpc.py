...
import start_pb2 as start__pb2
...
class SquareRootServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.squareRoot = channel.unary_unary(
                ...
                request_serializer=start__pb2.Number.SerializeToString,
                response_deserializer=start__pb2.Result.FromString,
                )
...
def add_SquareRootServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'squareRoot': grpc.unary_unary_rpc_method_handler(
                    servicer.squareRoot,
                    request_deserializer=start__pb2.Number.FromString,
                    response_serializer=start__pb2.Result.SerializeToString,
            ),
    }
...
class SquareRootService(object):
    ...
    def squareRoot(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/SquareRootService/squareRoot',
            start__pb2.Number.SerializeToString,
            start__pb2.Result.FromString,
