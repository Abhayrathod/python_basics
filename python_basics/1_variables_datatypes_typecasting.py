...
# var1 = "It's a String"
# var2 = 5
# print(isinstance(var2,int))             #checks if the datatype is what is provided in the 1st argument, returns true of false
# print(var1+str(var2)) # ''' It will give an error as we can't add string to any number. '''
# var1 = "My Name is "
# var2 = 25
# var3 = var1 + var2 +" & I am a programmer."
# print(var3)
...
# print(str(abc)+" "+str(45)) # It will give an error as abc has been changed into string.
...
# num2=input()
# num3 = (num1 + num2)
# print("The Sum is",num3) #It will give output as sum of two numbers.
...
# iter = 100 * str(int(var1) + int(var4))
# for i in iter:
#     print(i)
